use crate::ast::{AssignmentNode, BinaryOperationNode, BinaryOperationType, CallNode, DeclarationNode, FileNode, FunctionNode, IdentifierNode, Node, NumberNode, ParameterNode, ReturnNode, ScopeNode, TernaryNode};
