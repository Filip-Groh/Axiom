use std::ops::Deref;
use crate::ast::{AssignmentNode, BinaryOperationNode, BinaryOperationType, CallNode, DeclarationNode, FileNode, FunctionNode, IdentifierNode, IfElseNode, Node, NumberNode, ParameterNode, ReturnNode, ScopeNode, TernaryNode};
...
impl Parser {
    ...
    fn ternary(&mut self) -> Result<Box<Node>, AxiomError> {
